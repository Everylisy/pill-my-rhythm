...
const description = [
    ...
    buttons: [
      {
        tagName: "div",
        title:
          '<input type="checkbox" id="never-show-up-today" /><p>오늘 하루 더이상 보이지 않기</p>',
      ...
      },
      {
        ...
        class: "popout",
        onClick: function () {
          const isChecked = $('input:checkbox[id="never-show-up-today"]').is(
            ":checked",
          );
          if (isChecked) {
  ...
  },
  {
    ...
    title: "구독 서비스 이용하기",
    description:
      "Web과 Android 환경에서 각각 구독 신청 후 영양제 알림 서비스를 받아보실 수 있습니다.",
  },
  {
  ...
  },
  {
    ...
    title: "생체리듬 개선 활동",
    description:
      "생체리듬 개선에 좋은 활동들을 드래그앤드롭으로 설정할 수 있습니다.",
  },
  {
  ...
  },
  {
    ...
    title: "체크리스트 작성",
    description:
      "날짜를 클릭하면 오늘의 활동들을 잘 이행했는지 체크리스트를 작성할 수 있습니다.",
  },
];
