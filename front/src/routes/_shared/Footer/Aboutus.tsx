      ...
      <div className="w-full py-20 min-h-screen flex flex-col md:flex-row items-center justify-center">
        <div className="card m-4 w-[25rem] glass p-2 md:p-4 flex flex-wrap items-center justify-center">
          ...
          <div className="card-body p-2 m-2 break-words text-center">
            <div className="flex flex-row items-center justify-center">
              <h1 className="text-2xl font-bold leading-relaxed md:leading-normal text-teal-300 m-2">
                노송희 BE
              </h1>
              <a
                href="https://github.com/s0n9h2"
                target="_blank"
                rel="noreferrer"
              >
                <svg
        ...
        <div className="card m-4 w-[25rem] glass p-2 md:p-4 flex flex-wrap items-center justify-center">
          ...
          <div className="card-body p-2 m-2 break-words text-center">
            <div className="flex flex-row items-center justify-center">
              ...
              <a
                href="https://github.com/ParkJungYoon "
                target="_blank"
                rel="noreferrer"
              >
                <svg
            ...
            <p className="text-sm text-teal-100 font-bold">
              엔젯오리진 빌베리 루테인 토탈 아이케어
            </p>
            <p className="text-sm text-teal-100">
              개발로 잃은 시력, 영양제 먹고 유지라도 하자.
            </p>
            <p className="leading-loose text-white text-base">
        ...
        <div className="card m-4 w-[25rem] glass p-2 md:p-4 flex flex-wrap items-center justify-center">
          ...
          <div className="card-body p-2 m-2 break-words text-center">
            <div className="flex flex-row items-center justify-center">
              ...
              <a
                href="https://github.com/reina-dev"
                target="_blank"
                rel="noreferrer"
              >
                <svg
        ...
        <div className="card m-4 w-[25rem] glass p-2 md:p-4 flex flex-wrap items-center justify-center">
          <div className="p-4 md:p-2 avatar">
            <div className="w-48 mask mask-squircle">
              <img
                src="https://blog.kakaocdn.net/dn/vO7am/btrGgmP85uE/v8PNL6SSy6qKk6PsjsNPS1/img.png"
                alt="텐텐"
              />
            </div>
          </div>
          <div className="card-body p-2 m-2 break-words text-center">
            <div className="flex flex-row items-center justify-center">
              ...
              <a
                href="https://github.com/Everylisy"
                target="_blank"
                rel="noreferrer"
              >
                <svg
